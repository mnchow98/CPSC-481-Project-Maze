...
## How to Play
* Use arrow keys (UP, DOWN, LEFT, RIGHT) to move through the maze
* Navigate to the bottom-right corner to complete the maze
* Upon reaching the end, press **U** to run UCS or **A** to run A*
